...
class AddProduct extends Component {
  ...
  handleSubmit(e) {
     ...
     */
     if(!this.state.errors["description"] && !this.state.errors["summary"] && !this.state.errors["first name"] && !this.state.errors["last name"] && this.state.newProduct.property){
      this.props.onAdd(this.state.newProduct);
}
      else{for(const key in this.state.newProduct){
        let value = this.state.newProduct[key];
        console.log(value);
